...
#define PRELOG "[Visu::LinesColored] "
...
VuRenderObject *vu_lines_colored_new(VuVisu *visu,
                                     pCloud points,
                                     pCloud colors,
                                     float line_size,
    ...
    // public
    VuLinesColored *self = p_rhc_calloc(sizeof *self);
    ...
    object_base_init(&impl->super, visu, "LinesColored", &program, unload, kill_impl, update, render);
...
static void kill_impl(VuRenderObject *super) {
    VuLinesColored *self = (VuLinesColored *) super;
